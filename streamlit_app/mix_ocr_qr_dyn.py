...
# =========================================================
def run_ocr_qr_merge(session_dir, fast_mode=True, rate_limit=4):
    """
    Wrapper function to run OCR+QR merge as an imported module.
    ...
    """
    global SESSION_DIR, SOURCE_FOLDER, RENAMED_DIR, OCR_FILE, QR_FILE, OUTPUT_FILE
    
    # Set dynamic paths
    SESSION_DIR = Path(session_dir)
    SOURCE_FOLDER = SESSION_DIR / "uploads"
    RENAMED_DIR = SESSION_DIR / "renamed"
    OCR_FILE = SESSION_DIR / "gemini_output.json"
    QR_FILE = SESSION_DIR / "final_superqr_v6_clean.json"
    OUTPUT_FILE = SESSION_DIR / "mix_ocr_qr.json"
    ...
    try:
        ...
        if OUTPUT_FILE.exists():
            print(f"✅ OCR+QR merge completed: {OUTPUT_FILE}")
